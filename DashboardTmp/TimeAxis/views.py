...
from TimeAxis.fusioncharts import FusionCharts
from TimeAxis.fusioncharts import FusionTable
from TimeAxis.fusioncharts import TimeSeries
import requests
...
def chart(request):
    ...
    fcChart = FusionCharts("timeseries", "ex1", 700, 450,
                           "chart-1", "json", timeSeries)

    # returning complete JavaScript and HTML code, which is used to generate chart in the browsers.
    return render(request, 'TimeAxis/index.html', {'output': fcChart.render()})
